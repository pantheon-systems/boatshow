...
(function (factory) {
  ...
  var version = '0.1',
    ...
    getDefaultTemplate = function () {
      return '<div class="modal-context">' +
        '  <div class="modal-container container" data-modal-control="container">' +
  ...
  Modal.prototype = {
    ...
    init: function () {
      ...
      $(document).on('click', '[data-modal-control="close"]', function () {
        closeModal();
      });

      //This code closes the modal if a click occurs outside of the modal
