...
namespace Drupal\change_author_action\Plugin\Action;
 ...
 *
 * @Action(
 *   id = "change_author_action_base",
 *   label = "Change author",
 *   type = "node",
 *   confirm_form_route_name = "change_author_action.form"
 * )
 */
class ChangeAuthorActionBase extends ActionBase implements ContainerFactoryPluginInterface {
  /**
   * The plugin_id.
   *
   * @var pluginId
  ...
  public function executeMultiple(array $entities) {
    ...
    $this->tempStoreFactory->get('change_author_ids')
