...
var options = {
  ...
  styleGuide: {
    ...
    files: [
      path.join(paths.styles.source, '**/*.twig'),
      path.join(paths.templates, '**/*.twig'),
      path.join(paths.templates, 'styleguide/builder/**/*.twig')
    ],
    ...
    css: [
      ...
      path.relative(paths.templates, paths.scripts.libraries + '/jquery-background-video/jquery.background-video.css'),
      path.relative(paths.templates, paths.scripts.libraries + '/jquery-ui/jquery-ui.min.css'),
      path.relative(paths.templates, paths.scripts.libraries + '/chosen/chosen.min.css'),
    ...
    js: [
      path.relative(paths.templates, paths.scripts.libraries + '/social/facebook.js'),
      path.relative(paths.templates, paths.scripts.libraries + '/social/twitter.js'),
      path.relative(paths.templates, paths.scripts.libraries + '/slick/slick.min.js'),
      path.relative(paths.templates, paths.scripts.libraries + '/jquery-background-video/jquery.background-video.js'),
      path.relative(paths.templates, paths.scripts.libraries + '/chosen/chosen.jquery.min.js'),
      path.relative(paths.templates, paths.scripts.libraries + '/fitVids/fitVids.js'),
      path.relative(paths.styleGuide, paths.scripts.destination + '/0-utility/global.js'),
      path.relative(paths.styleGuide, paths.scripts.destination + '/3-molecules/social-share.js'),
      path.relative(paths.styleGuide, paths.scripts.destination + '/4-organisms/accordion.js'),
      path.relative(paths.styleGuide, paths.scripts.destination + '/4-organisms/header.js'),
      path.relative(paths.styleGuide, paths.scripts.destination + '/4-organisms/mobile-nav.js'),
      path.relative(paths.styleGuide, paths.scripts.destination + '/4-organisms/nmma-slick.js'),
      path.relative(paths.styleGuide, paths.scripts.destination + '/4-organisms/brand-grid.js'),
      path.relative(paths.styleGuide, paths.scripts.destination + '/4-organisms/forms.js'),
      path.relative(paths.styleGuide, paths.scripts.destination + '/4-organisms/videos.js'),
      '/modules/custom/nmma_megamenu/js/subnav.js',
    ],
