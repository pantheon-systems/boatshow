...
if (file_exists('/var/www/site-php')) {
  require '/var/www/site-php/boatshow/newengland-settings.inc';
}
 ...
 * Multisite variables.
 */
$settings['boatshow.city.key'] = 'newengland';
$settings['boatshow.city.searchId'] = '30';

$config['system.site']['name'] = 'Newengland City Boat Show';
$config['gtm.settings']['google-tag'] = 'GTM-TP9JNJZ';
