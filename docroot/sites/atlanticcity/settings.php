...
$settings['trusted_host_patterns'] = array(
  '^local\.atlanticcity\.com$',
  '^atlanticcityboatshow\.com$',
  '^.+\.atlanticcityboatshow\.com$',
...
if (file_exists('/var/www/site-php')) {
  require '/var/www/site-php/boatshow/atlanticcity-settings.inc';
}
 ...
 * Multisite variables.
 */
$settings['boatshow.city.key'] = 'atlanticcity';
$settings['boatshow.city.searchId'] = '30';

$config['system.site']['name'] = 'atlantic City Boat Show';
$config['gtm.settings']['google-tag'] = 'GTM-T44TX3Q';
