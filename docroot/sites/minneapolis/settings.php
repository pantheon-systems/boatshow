...
if (file_exists('/var/www/site-php')) {
  require '/var/www/site-php/boatshow/minneapolis-settings.inc';
}
 ...
 * Multisite variables.
 */
$settings['boatshow.city.key'] = 'minneapolis';
$settings['boatshow.city.searchId'] = '30';

$config['system.site']['name'] = 'Minneapolis City Boat Show';
$config['gtm.settings']['google-tag'] = 'GTM-MK54G3X';
