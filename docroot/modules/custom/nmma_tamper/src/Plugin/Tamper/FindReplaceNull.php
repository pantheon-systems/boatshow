 ...
 *
 * @Tamper(
 *   id = "find_replace_null",
 *   label = @Translation("Find replace w/NULL"),
 *   description = @Translation("Find and replace text, accepts empty values."),
 *   category = "Text"
 * )
 */
class FindReplaceNull extends TamperBase {
